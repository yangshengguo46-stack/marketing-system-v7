...
9. G4p is a repeatable provider onboarding proof, not a new blocking main plan. Failure keeps that second route disabled and cannot delay G2, G6, G4a, the Volcengine business loop, or a release that does not enable or advertise the second route.
