...
class ProcessLifecycleLease:
    ...
    attempt_id: str
    launch_spec_sha256: str
    _state: ProcessLeaseState = field(init=False, default=ProcessLeaseState.RESERVED)
    _process_id: int | None = field(init=False, default=None)
    _process_group_id: int | None = field(init=False, default=None)
    _owned_process: object | None = field(init=False, default=None)
    _orphaned_process: OrphanedProcess | None = field(init=False, default=None)
